Pod::Spec.new do |spec|
	...
	spec.version			= '2.33.0-20190404-2d6cce03d'
	...
	spec.source				= { :http => 'http://releases.payworks.io/artifactory/mpos-ios/io/payworks/mpos.ios.ui/2.33.0/mpos.ios.ui-2.33.0.zip' }
