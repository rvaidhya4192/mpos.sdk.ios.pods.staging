Pod::Spec.new do |spec|
    spec.name               = 'payworks'
    spec.version            = '3.33.0-20181210-b2e76eb0e'
    ...
    spec.source             = { :http => 'https://releases.payworks.io/artifactory/mpos-ios-staging/io/payworks/mpos.ios.sdk/3.33.0-20181210-b2e76eb0e/mpos.ios.sdk-3.33.0-20181210-b2e76eb0e.zip' }
